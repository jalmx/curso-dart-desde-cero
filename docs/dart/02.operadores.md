...
Existen mas operadores, para mas información ir al documentación oficial de dart en [https://dart.dev/language/operators#assignment-operators](https://dart.dev/language/operators#assignment-operators)
